                ...
                <div className="itinerario__content">
                    ...
                    <div className="itinerario__line">
                        ...
                        <div className="icons__text text__iglesia">
                            <p className="iglesia__text">Ceremonia<br></br>Religiosa<br></br>06:30 pm</p>
                        </div>
                        ...
                        <div className="icons__text text__reception">
                            <p className="reception__text">Recepción<br></br>Bienvenida<br></br>08:00 pm</p>
                        </div>
